...
PATH_LIBSDYOGEN=${1}
cython ${PATH_LIBSDYOGEN}/utils/extractDiags.pyx
# C compilation of utils/extractSbs.c into utils/extractSbs.so that can be used as a python package
gcc -shared -pthread -fPIC -fwrapv -O2 -Wall -fno-strict-aliasing -I/usr/include/python2.7 -o ${PATH_LIBSDYOGEN}/utils/extractDiags.so ${PATH_LIBSDYOGEN}/utils/extractDiags.c
